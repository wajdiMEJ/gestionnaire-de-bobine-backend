...
import repository.ActionHistoriqueRepository;
import repository.BobineRepository;
import repository.BobineUtiliseeRepository;
...
public class GestionnaireStock {
    ...
    public void supprimerBobine(Long id) {
        ...
        List<entity.BobineUtilisee> utilisations = bobineUtiliseeRepository.findByBobineId(id);
